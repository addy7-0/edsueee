...
const FREQUENT_FLYER_STATUS_URI = 'https://www.qantas.com/travel/airlines/flight-search/global/en';
...
export default async function decorate(block) {
  ...
  block.innerHTML = '<div class="qdd-login-ribbon-host" data-widget-host="qdd-login-ribbon"></div>';
