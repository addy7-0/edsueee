...
import pictureFromImageCell from '../../scripts/utils/block-picture.js';
 ...
 */
async function decorateItem(parentBlock, block, _layoutClass, classes = []) {
  const [
    image,
    hideAltText,
    caption,
  ...
  const pictureEl = pictureFromImageCell(image, {
  ...
  const buildLinkElements = () => {
    ...
    anchors.forEach((anchor) => {
      ...
      anchor.addEventListener('click', () => triggerBlockCardClick(
        'image_and_text',
