...
async function getSkipToElements(template = '') {
  ...
  if (Array.isArray(additionalSkipToElements)) {
    additionalSkipToElements.forEach(({ anchorId, placeholderId }) => {
      ...
      const anchorTabExist = document.querySelector(`[data-tab-id='${anchorId}']`) !== null;
      const anchorSectionExist = document.querySelector(`[data-anchor-section-url='${anchorId}']`) !== null;
